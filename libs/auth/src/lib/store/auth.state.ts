...
import { SioCoreLoggerService, SioCoreAppComponentState } from '@silicia/core';

import { SioAuthPluginService } from '../services/plugins';
  ...
  implements NgxsOnInit
{
  ...
  public setRedirectTo(value: { path: string }[]) {
    ...
    this.sioCoreLoggerService.debug(
      '[SioAuthState][setRedirectTo] Set redirect url to ' + value,
      this.snapshot.routes.redirectTo,
    );
  }
  ...
  public async checkSession(): Promise<boolean> {
    try {
      this.sioCoreLoggerService.info('[SioAuthState][checkSession] - Get Session');
